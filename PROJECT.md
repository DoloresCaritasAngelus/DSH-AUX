...
> 🔻 快照（2026-09-18）：包版本 `0.4.6-fix.2` · 主支 DSH `0.1.5-rc.2` · 测试基线 628。
...
- 当前版本：`0.4.6-fix.2`（`dsh-aux/package.json`）🔻 版本号与徽章随发布单独更新
- Node：>= 20
...
- 全量测试：`node --test tests/*.test.js`；🔻 基线 **628**（2026-09-18 快照，以实跑 `# pass/# fail` 为准，文件清单见 `TESTING.md`）。
