...
> 状态:🗄 已归档
> 退役原因:功能 2026-09-17 退役 —— 官方 DSH 原生已具备子代理模型选择,AUX 的透明接管成为重复能力;代码、测试与三个宿主补丁移入 `retired/subagent-bridge/`
> 取代者:`retired/subagent-bridge/`(仅留痕)+ 官方 `dsh-tool-subagent` 原生能力
> 复盘点:仅作对照,不据此恢复
> 最后核实:2026-09-17
> 🔻 版本快照:dsh-aux v0.3.0 / DSH 0.1.2 线
