...
> 状态:🔵 已实现(保留作回执)
> 退役原因:功能已于 2026-08-14 落地(session/disposed 事件驱动清理),文档不再维护
> 取代者:代码 dsh-aux/src/images/** 的归属/GC 模块 + CHANGELOG 0.1.2
> 复盘点:附件对象库结构或 session/disposed 语义变化时
> 最后核实:2026-09-09
> 🔻 版本快照:dsh-aux v0.1.2 线
