 ...
 *
 * Lists regular files inside real (non-symlinked) bucket directories, including
 * both extensionless object files and extension hardlinks. Symlinks are never
 * followed: each directory and file is verified with lstat.
 *
