...
- **Zero-dependency tests**: `node --test tests/*.test.js` (161 total: aux 102 / compression 35 / core-review 4 / fetch-vision 4 / images-review 7 / bridge-target 4 / memory 1 / bridge 4).
